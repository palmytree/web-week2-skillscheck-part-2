...
const dragonMapper = arr => arr.map(e => e + "...here be dragons");
...
const cookieLoversOnly = arr => arr.filter(e => e.favoriteCookie);
...
const changeValue = (arr, instructions) => arr.forEach(e => instructions(e));
...
const findProduct = arr => arr.reduce((acc, cur) => acc * cur, 1);
