...
const whatAmI = mystery => typeof mystery
...
const nananan = x => isNaN(x / 2) ? 'FLYING NOCTURNAL MAMMAL MAN!' : x / 2
...
const arrayChecker = arr => Array.isArray(arr)
...
const numFromString = str => parseInt(str, 10)
...
const makeItAString = x => x.toString()
